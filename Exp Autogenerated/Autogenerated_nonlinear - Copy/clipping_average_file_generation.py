...
ql_0_2 = [f'{i}//clipped_QL_0_3.csv' for i in range(avg)]
ql_0_3 = [f'{i}//clipped_QL_0_5.csv' for i in range(avg)]
...
ql_0_1_avg.to_csv('clipped-QL_0_1.csv', index=False)
ql_0_2_avg.to_csv('clipped-QL_0_3.csv', index=False)
ql_0_3_avg.to_csv('clipped-QL_0_5.csv', index=False)
