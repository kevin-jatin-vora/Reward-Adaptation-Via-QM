...
def test_agent(test_runs=1,max_t=200):
...
# def dqn(n_episodes=50000, max_t=475, eps_start=1.0, eps_end=0.01, eps_decay=0.995):
    ...
    # for i_episode in range(1, n_episodes+1):
        ...
        # for t in range(max_t):
            ...
            # # max_cart_position = 2.4  # Maximum distance from the center
            # # max_pole_angle = 0.2094  # Maximum angle from vertical
            
            # # Calculate scaled rewards
            # R1 = (1 - abs(pole_angle)) #/ max_pole_angle
            # R2 = (1 - abs(cart_position)) #/ max_cart_position
            
            # # Combine R1 and R2 to form the overall reward
            # reward = R1 + R2 
            # agent.step(state, action, reward, next_state, done)
            # state = next_state
            # score += reward
