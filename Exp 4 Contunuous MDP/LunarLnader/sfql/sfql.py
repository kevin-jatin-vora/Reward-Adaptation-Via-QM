...
with open(r'C:\Users\kvora1\Desktop\LunarLnader\behaviors\LL_b1.pkl', 'rb') as handle:
    Q1 = dill.load(handle)
Q1 = defaultdict(default_value, Q1)

with open(r'C:\Users\kvora1\Desktop\LunarLnader\behaviors\LL_b2.pkl', 'rb') as handle:
    Q2 = dill.load(handle)
