...
ours_0_5 = [f'{i}//ours_0_3.csv' for i in range(avg)]
# ours_0_3 = [f'{i}//ours_0_5.csv' for i in range(avg)]
ours_0_9 = [f'{i}//ours_0_5.csv' for i in range(avg)]

ql_0_1 = [f'{i}//QL_0_1.csv' for i in range(avg)]
ql_0_5 = [f'{i}//QL_0_3.csv' for i in range(avg)]
# ql_0_3 = [f'{i}//QL_0_5.csv' for i in range(avg)]
ql_0_9 = [f'{i}//QL_0_5.csv' for i in range(avg)]

sfql_0_1 = [f'{i}//SFQL_0_1.csv' for i in range(avg)]
sfql_0_5 = [f'{i}//SFQL_0_3.csv' for i in range(avg)]
# sfql_0_3 = [f'{i}//SFQL_0_5.csv' for i in range(avg)]
sfql_0_9 = [f'{i}//SFQL_0_5.csv' for i in range(avg)]
...
ours_0_5_avg.to_csv('ours_0_3.csv', index=False)
# ours_0_3_avg.to_csv('ours_0_5.csv', index=False)
ours_0_9_avg.to_csv('ours_0_5.csv', index=False)

ql_0_1_avg.to_csv('QL_0_1.csv', index=False)
ql_0_5_avg.to_csv('QL_0_3.csv', index=False)
# ql_0_3_avg.to_csv('QL_0_5.csv', index=False)
ql_0_9_avg.to_csv('QL_0_5.csv', index=False)

sfql_0_1_avg.to_csv('sfql_0_1.csv', index=False)
sfql_0_5_avg.to_csv('sfql_0_3.csv', index=False)
# sfql_0_3_avg.to_csv('sfql_0_3.csv', index=False)
sfql_0_9_avg.to_csv('sfql_0_5.csv', index=False)