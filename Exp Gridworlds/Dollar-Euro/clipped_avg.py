...
ql_0_1 = [f'{i}//clipped_QL_0_1.csv' for i in range(avg)]
ql_0_2 = [f'{i}//clipped_QL_0_2.csv' for i in range(avg)]
ql_0_3 = [f'{i}//clipped_QL_0_3.csv' for i in range(avg)]
ql_0_4 = [f'{i}//clipped_QL_0_4.csv' for i in range(avg)]
...
ql_0_2_avg.to_csv('clipped_QL_0_2.csv', index=False)
ql_0_3_avg.to_csv('clipped_QL_0_3.csv', index=False)
ql_0_4_avg.to_csv('clipped_QL_0_4.csv', index=False)
